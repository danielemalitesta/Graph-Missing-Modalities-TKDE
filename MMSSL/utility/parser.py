...
def parse_args():
    ...
    # parser.add_argument('--cl_rate', type=float, default=0.03)
    # parser.add_argument('--drop_rate', type=float, default=0.2)
    # parser.add_argument('--model_cat_rate', type=float, default=0.55)
    ...
    # parser.add_argument('--G_rate', default=0.0001, type=float)  #
    # parser.add_argument('--m_topk_rate', default=0.02, type=float)
    #----sports - --------------------

    #train
    parser.add_argument('--data_path', nargs='?', default='../data/', help='Input data path.')
    parser.add_argument('--seed', type=int, default=123, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='Digital_Music', help='Choose a dataset from {sports, baby, clothing, tiktok, allrecipes}')
    ...
    # missing
    parser.add_argument('--missing_layers', type=int, default=1)
