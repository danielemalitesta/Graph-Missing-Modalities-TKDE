...
for it in os.listdir(visual_folder_original):
    np.save(f'{visual_folder_original_indexed}/{items_map[it.split(".npy")[0]]}.npy', np.load(f'{visual_folder_original}/{it}'))

for it in os.listdir(textual_folder_original):
    np.save(f'{textual_folder_original_indexed}/{items_map[it.split(".npy")[0]]}.npy', np.load(f'{textual_folder_original}/{it}'))

for it in os.listdir(visual_folder_imputed):
    np.save(f'{visual_folder_imputed_indexed}/{items_map[it.split(".npy")[0]]}.npy', np.load(f'{visual_folder_imputed}/{it}'))

for it in os.listdir(textual_folder_imputed):
    np.save(f'{textual_folder_imputed_indexed}/{items_map[it.split(".npy")[0]]}.npy', np.load(f'{textual_folder_imputed}/{it}'))
