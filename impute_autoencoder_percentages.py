...
if args.missing_modality == 'visual':
    ...
    missing_textual_indexed = pd.read_csv(os.path.join(f'data/{args.data}', f'missing_textual_indexed_{args.percentage}_{args.round}.tsv'), sep='\t', header=None)
...
if args.method == 'gae':
    if not os.path.exists(output_visual + f'_{args.top_k}'):
        os.makedirs(output_visual + f'_{args.top_k}')
    if not os.path.exists(output_textual + f'_{args.top_k}'):
        os.makedirs(output_textual + f'_{args.top_k}')
else:
...
if args.method == 'ae':
    ...
    output_visual = output_visual + f'_{args.top_k}'
    output_textual = output_textual + f'_{args.top_k}'
